# BeModelOrganisationClaim (revendication de modèle d'organisation) - CareSets - data models v0.1.0

## Modèle logique: BeModelOrganisationClaim (revendication de modèle d'organisation) 
...
Autres représentations du profil : [CSV](../StructureDefinition-BeModelOrganisationClaim.csv), [Excel](../StructureDefinition-BeModelOrganisationClaim.xlsx) 
