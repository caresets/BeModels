# Ordonnance infirmière modèle - CareSets - data models v0.1.0

## Modèle logique: Ordonnance infirmière modèle 
...
Autres représentations du profil : [CSV](../StructureDefinition-BeModelNursingPrescription.csv), [Excel](../StructureDefinition-BeModelNursingPrescription.xlsx) 
