# Modèle de prescription pour la radiologie - CareSets - data models v0.1.0

## Modèle logique: Modèle de prescription pour la radiologie 
...
Cette structure est dérivée de [BeModelReferralPrescription](StructureDefinition-BeModelReferralPrescription.md) 
...
Autres représentations du profil : [CSV](../StructureDefinition-BeModelRadiologyPrescription.csv), [Excel](../StructureDefinition-BeModelRadiologyPrescription.xlsx) 
