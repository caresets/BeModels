# Modèle BeObservation - CareSets - data models v0.1.0

## Modèle logique: Modèle BeObservation 
...
Autres représentations du profil : [CSV](../StructureDefinition-be-model-observation.csv), [Excel](../StructureDefinition-be-model-observation.xlsx) 
