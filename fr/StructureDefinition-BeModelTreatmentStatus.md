# État du traitement du modèle BeModel - CareSets - data models v0.1.0

## Modèle logique: État du traitement du modèle BeModel 
...
Autres représentations du profil : [CSV](../StructureDefinition-BeModelTreatmentStatus.csv), [Excel](../StructureDefinition-BeModelTreatmentStatus.xlsx) 
