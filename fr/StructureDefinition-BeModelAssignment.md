# Affectation d'un modèle - CareSets - data models v0.1.0

## Modèle logique: Affectation d'un modèle 
...
Autres représentations du profil : [CSV](../StructureDefinition-BeModelAssignment.csv), [Excel](../StructureDefinition-BeModelAssignment.xlsx) 
