...
## Logisch model: BeModelNursingPrescription 
...
Andere representaties van het profiel: [CSV](../StructureDefinition-BeModelNursingPrescription.csv), [Excel](../StructureDefinition-BeModelNursingPrescription.xlsx) 
