# BeModelTreatmentStatus - CareSets - data models v0.1.0

## Logisch model: BeModelTreatmentStatus 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.be.fhir.models|current/StructureDefinition/BeModelTreatmentStatus)
...
Vereist: 0 element(3 genest vereist elements)
...
Andere representaties van het profiel: [CSV](../StructureDefinition-BeModelTreatmentStatus.csv), [Excel](../StructureDefinition-BeModelTreatmentStatus.xlsx) 
...
```json
{
  ...
  "url" : "http://example.org/StructureDefinition/BeModelTreatmentStatus",
  "version" : "0.1.0",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "http://example.org/StructureDefinition/BeModelTreatmentStatus",
          ...
          "extension" : [
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "UUID (voir Doc : https://docs.google.com/document/d/13qamEPfdQ2HgUiXmjwHQNchpEU3LsQHF5MN9jKufX2g/edit?usp=sharing ) Absent lors de la création par le logiciel client, sinon toujours présent."
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            },
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "UUID (zie Doc: https://docs.google.com/document/d/13qamEPfdQ2HgUiXmjwHQNchpEU3LsQHF5MN9jKufX2g/edit?usp=sharing ) Afwezig tijdens creatie door clientsoftware, anders altijd aanwezig."
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            }
          ...
          "extension" : [
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "Date de début du traitement"
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            },
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "Begindatum van verwerking"
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            }
          ...
          "extension" : [
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "Date de fin de traitement"
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            },
            {
              "extension" : [
                ...
                {
                  "url" : "content",
                  "valueString" : "Einddatum van verwerking"
                }
              ],
              "url" : "http://hl7.org/fhir/StructureDefinition/translation"
            }
